...
const double PlanckConstantOverTwoPi =
    6.58211889e-16;                           // Planck constant / (2 pi) [eV.s]
...
const double hbarc =
    PlanckConstantOverTwoPi * speedOfLight * 1e9; // Hbar.c [MeV.fm]
...
// const double NORM_FACT      = 10.0 ; /* conversion factor to [mb] */ const
// double SPIN_CUTOFF    = 1e-8 ; /* cut-off of total anuglar momentum     */
...
// const double MNEUTRON   =  1.008664891    ; /* Neutron Weight  [amu] */ const
// double MPROTON    =  1.007276487    ; /* Proton Weight   [amu]          */
// const double MDEUTERON  =  2.0141018      ; /* Deuteron Weight [amu] */ const
// double MTRITON    =  3.0160494      ; /* Triton Weight   [amu]          */
// const double MHELIUM3   =  3.0260294      ; /* Helium-3 Weight [amu] */ const
// double MALPHA     =  4.0026032      ; /* Alpha Weight    [amu]          */
