...
public:
  ...
  double getCmNeutronEnergy(int index) {
    if (index >= 0 && index < neutronNu)
      return cmNeutronEnergies[index];
    else
      return -1;
  }
  double getCmNeutronDircosu(int index) {
    if (index >= 0 && index < neutronNu)
      return cmNeutronDircosu[index];
    else
      return -1;
  }
  double getCmNeutronDircosv(int index) {
    if (index >= 0 && index < neutronNu)
      return cmNeutronDircosv[index];
    else
      return -1;
  }
  double getCmNeutronDircosw(int index) {
    if (index >= 0 && index < neutronNu)
      return cmNeutronDircosw[index];
    else
      return -1;
  }
...
public:
  ...
  double getLightFragmentPreMomentumX() {
    return eventLF.preFragmentMomentum[0];
  }
  double getLightFragmentPreMomentumY() {
    return eventLF.preFragmentMomentum[1];
  }
  double getLightFragmentPreMomentumZ() {
    return eventLF.preFragmentMomentum[2];
  }
  ...
  double getLightFragmentPostMomentumX() {
    return eventLF.postFragmentMomentum[0];
  }
  double getLightFragmentPostMomentumY() {
    return eventLF.postFragmentMomentum[1];
  }
  double getLightFragmentPostMomentumZ() {
    return eventLF.postFragmentMomentum[2];
  }
  ...
  double getHeavyFragmentPreMomentumX() {
    return eventHF.preFragmentMomentum[0];
  }
  double getHeavyFragmentPreMomentumY() {
    return eventHF.preFragmentMomentum[1];
  }
  double getHeavyFragmentPreMomentumZ() {
    return eventHF.preFragmentMomentum[2];
  }
  ...
  double getHeavyFragmentPostMomentumX() {
    return eventHF.postFragmentMomentum[0];
  }
  double getHeavyFragmentPostMomentumY() {
    return eventHF.postFragmentMomentum[1];
  }
  double getHeavyFragmentPostMomentumZ() {
    return eventHF.postFragmentMomentum[2];
  }

  int getPreFissionNeutronNu() { return preFissionNeutronNu; }

  double getPreFissionNeutronEnergy(int index) {
    if (index >= 0 && index < preFissionNeutronNu)
      return preFissionNeutronEnergies[index];
    else
      return -1;
  }
  ...
  double getPreFissionNeutronDircosu(int index) {
    if (index >= 0 && index < preFissionNeutronNu)
      return preFissionNeutronDircosu[index];
    else
      return -1;
  }
  double getPreFissionNeutronDircosv(int index) {
    if (index >= 0 && index < preFissionNeutronNu)
      return preFissionNeutronDircosv[index];
    else
      return -1;
  }
  double getPreFissionNeutronDircosw(int index) {
    if (index >= 0 && index < preFissionNeutronNu)
      return preFissionNeutronDircosw[index];
    else
      return -1;
  }
