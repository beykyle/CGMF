...
double gdrGammaTransmission(GammaProfile, int, double, GammaMultipol, double,
                            double);
...
/*      gampop.cpp                    */
/**************************************/
double specTransitionGamma(Statcalcmode, int, int, int, double **, double,
                           Nucleus *, double *);

/**************************************/
/*      parpop.cpp                    */
/**************************************/
double specTransitionParticle(Statcalcmode, int, int, int, Transmission *,
