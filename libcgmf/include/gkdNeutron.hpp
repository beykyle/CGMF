...
struct OMPFile {
  virtual double real_radius(int zt, int at, double En) const = 0;
  virtual double so_radius(int zt, int at, double En) const   = 0;
  virtual double compl_surf_radius(int zt, int at, double En) const = 0;
  virtual double real_diffusivity(int zt, int at, double En) const = 0;
  virtual double so_diffusivity(int zt, int at, double En) const = 0;
  virtual double compl_surf_diffusivity(int zt, int at, double En) const = 0;

  virtual double real_central_depth(int zt, int at, double En) const = 0;
  virtual double compl_central_depth(int zt, int at, double En) const = 0;
  virtual double compl_surf_depth(int zt, int at, double En) const = 0;
  virtual double real_so_depth(int zt, int at, double En) const = 0;
  virtual double compl_so_depth(int zt, int at, double En) const = 0;
};
...
struct GKDNeutron : public OMPFile {
  ...
  // potential shapes
  double real_radius(int zt, int at, double En) const final;
  double so_radius(int zt, int at, double En) const final;
  double compl_surf_radius(int zt, int at, double En) const final;
  double real_diffusivity(int zt, int at, double En) const final;
  double so_diffusivity(int zt, int at, double En) const final;
  double compl_surf_diffusivity(int zt, int at, double En) const final;

  // potential depths
  double real_central_depth(int zt, int at, double En) const final;
  double compl_central_depth(int zt, int at, double En) const final;
  double compl_surf_depth(int zt, int at, double En) const final;
  double real_so_depth(int zt, int at, double En) const final;
  double compl_so_depth(int zt, int at, double En) const final; 
