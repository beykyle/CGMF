...
This is a modified version of CGMF for use in uncertainty quantification. Includes [nlohmann/json](https://github.com/nlohmann/json) as a git submodule to handle json parsing. 
